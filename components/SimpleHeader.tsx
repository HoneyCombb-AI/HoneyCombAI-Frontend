...
const HoneyCombIcon = ({ className }: { className?: string }) => (
  <div className={`relative ${className}`}>
    <div className="h-12 w-12 bg-linear-to-br from-amber-400 to-yellow-500 rounded-2xl shadow-2xl shadow-amber-500/25 rotate-3 hover:rotate-0 transition-transform duration-700">
    </div>
...
export function SimpleHeader({ currentPage }: SimpleHeaderProps): JSX.Element {
  ...
  return (
   ...
   {/* Left side */}
<div className="hidden md:flex bg-linear-to-r from-amber-300 via-amber-200 to-yellow-100/90 items-center px-[120px]">
  <Link href="/" className="inline-block">
    <div className="flex items-center gap-3">
      <HoneyCombIcon />
      <div className="flex items-center gap-2">
        <span className="font-bold text-xl bg-linear-to-r from-amber-600 to-yellow-500 bg-clip-text text-transparent tracking-tight">
          HoneyComb
        </span>

...
import type { GeolocationMetric } from '@/types/analytics';
...
export async function GET(req: NextRequest) {
    try {
        ...
        const { data: metrics, error: rpcError } = await supabase.rpc('get_geolocation_metrics', {
        ...
        return NextResponse.json({
            data: metrics as GeolocationMetric[]
        });
